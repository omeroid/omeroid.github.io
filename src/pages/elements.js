          ...
          <div className="grid-wrapper">
            <div className="col-6">
              ...
              <ul className="actions">
                <li>
                  <button className="button special">Default</button>
                </li>
                <li>
              ...
              <ul className="actions small">
                <li>
                  <button className="button special small">Small</button>
                </li>
                <li>
              ...
              <div className="grid-wrapper">
                ...
                <div className="col-6">
                  <ul className="actions vertical">
                    <li>
                      <button className="button special fit">Default</button>
                    </li>
                    <li>
                      <button className="button fit">Default</button>
                    </li>
                  </ul>
                </div>
                <div className="col-6">
                  <ul className="actions vertical small">
                    <li>
                      <button className="button special small fit">
                        Small
                      </button>
                    </li>
                    <li>
                      <button className="button small fit">Small</button>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-6">
              ...
              <ul className="actions">
                <li>
                  <button className="button big">Big</button>
                </li>
                <li>
                  <button className="button">Default</button>
                </li>
              ...
              <ul className="actions">
                <li>
                  <button className="button special big">Big</button>
                </li>
                <li>
                  <button className="button special">Default</button>
                </li>
              ...
              <ul className="actions fit">
                <li>
                  <button className="button special fit">Fit</button>
                </li>
                <li>
              ...
              <ul className="actions fit small">
                <li>
                  <button className="button special fit small">
                    Fit + Small
                  </button>
                </li>
                <li>
              ...
              <ul className="actions">
                <li>
                  <button className="button special icon fa-search">
                    Icon
                  </button>
                </li>
                <li>
                  <button className="button icon fa-download">Icon</button>
                </li>
              </ul>
              <ul className="actions">
                <li>
                ...
                <div className="grid-wrapper">
                  ...
                  <div className="col-12">
                    <div className="select-wrapper mb-5">
                      <label htmlFor="demo-category" className="sr-only">
                        Category
                      </label>
