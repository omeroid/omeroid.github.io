    ...
    <div id="main" className="alt">
      <section id="one">
        <div className="inner">
          ...
          <h4>第3条（個人情報の取得方法）</h4>
          <p>
            当社は、ユーザーが当社サービスの利用登録、及び問い合わせをする際に氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。
            <br />
          ...
          <h4>第9条（個人情報の開示）</h4>
          <p>
            当社は、本人から個人情報の開示を求められたときは、ユーザー本人に対し、遅滞なくこれを開示します。
            <br />
            ...
            <br />
            個人情報の開示を希望される方は、以下の手続きに従ってご請求ください。
            <br />
            ...
            送付先住所：〒143-0006
            <br />
            　　　　　　東京都大田区平和島6丁目1番1号　東京流通センターB棟1階(W1-4～7）まつの内
            <br />
          ...
          <p>
            ユーザーは、当社の保有する自己の個人情報が誤った情報である場合、当社が定める手続きにより、当社に対して個人情報の訂正、追加または削除（以下、「訂正等」といいます。）を請求することができます。
            <br />
