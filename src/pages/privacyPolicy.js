    ...
    <div id="main" className="alt">
        <section id="one">
            <div className="inner">
              <h2>プライバシーポリシー</h2>
              <p>
                omeroid株式会社（以下，「当社」といいます。）は，本ウェブサイト、および当社提供サービス上で提供するサービス（以下,「本サービス」といいます。）における，<br />ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
              </p>
